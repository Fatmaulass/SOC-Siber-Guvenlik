...
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=auto&height=200&section=header&text=Intrusion%20Detection%20System&fontSize=40&animation=fadeIn&fontColor=fff" />
</p>
...
## 1️⃣ Veri Seti ve Ön İşleme (Data Engineering)
...
## 2️⃣ Model Mimarisi: Neden XGBoost?
...
## 3️⃣ İki Aşamalı Tehdit Analizi
...
## 4️⃣ Açıklanabilir Yapay Zeka (SHAP Entegrasyonu)
...
## 5️⃣ Canlı SOC Dashboard (Streamlit)
